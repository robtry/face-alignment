...
int main()
{
	...
	// Image Path
	Mat image = imread("/root/workspace/test/img6.jpg");
	...
	{
		throw(0);
		cout << "Exception: Image is not read properly, please check imageath" << endl;
		return -1;
	}
	...
	shape_predictor sp;
	deserialize("/root/workspace/models/shape_predictor_68_face_landmarks.dat") >> sp;
	...
	face_cascade.detectMultiScale(dst, face, 1.1, 2, 0);
